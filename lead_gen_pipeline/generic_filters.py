"""Noise blocklists for extraction quality.

These sets enumerate placeholder, fictional, and generic values that commonly appear
in web pages but are not real business data: reserved example phone numbers, throwaway
example emails, generic company-name fragments, boilerplate navigation labels, and
parked/placeholder domains. The scraper consults them to drop low-value matches before
they reach the database. They are reference data, not test fixtures or mock results.
"""
...
# Google reserves 800-555-0100 through 800-555-0199 for examples.
GENERIC_PHONE_PATTERNS = {
    # North American Placeholders
    "555-0100",
    "555-0101",
    "555-0199",  # Common 555-01xx range
    "123-456-7890",
    "(123) 456-7890",
    "123.456.7890",
    "000-000-0000",
    ...
    "555-555-5555",
    "(555) 555-5555",
    "555.555.5555",  # Generic 555
    "012-345-6789",
    "800-555-0100",
    "800-555-0150",
    "800-555-0199",  # Google recommended range
...
GENERIC_EMAIL_DOMAINS = {
    ...
    "demo.com",
    "anydomain.com",
    # Domain endings are checked elsewhere; these are domains, not TLDs.
...
GENERIC_COMPANY_TERMS = {
    ...
    "welcome",
    "basic contact",
    "no info",  # From previous test failures
}
...
PLACEHOLDER_WEBSITE_DOMAINS = {
    ...
    # .test/.example/.localhost/.invalid are TLDs, checked at the TLD level.
}
